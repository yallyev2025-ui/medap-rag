...
# Приватный документ студента (§18 ТЗ, этап 4A.5) — своя source_type-база, чтобы
# обычный retrieval по учебникам/клинрекам никогда не задел чужой/личный контент.
SOURCE_USER_DOCUMENT = "документ_студента"

# Расширения, разрешённые для загрузки файла источника — как книги в админке,
